...
<form action="./api/edit_movie.php" method="post" enctype="multipart/form-data"> <!--有檔案上傳都要加enctype-->
<table style="width:75%; margin:auto">
    <tr>
        ...
        <td>
            ...
            <div><label>片長：</label><input type="number" name="length" value="<?=$row['length'];?>">分鐘</div>
